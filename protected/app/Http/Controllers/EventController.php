...
class EventController extends Controller
{
    ...
    public function index()
    {
        if(Auth::user()->jenis==='klien'){
            $history=Event::select('events.id as id','events.name as name','events.startevent as startevent','events.status as status','ratings.rate as rate','ratings.comment as comment')->where([['user_id',Auth::user()->id]])->leftjoin('ratings','ratings.event_id','=','events.id')->orderBy('events.created_at','ASC')->get();
            // return $history;
